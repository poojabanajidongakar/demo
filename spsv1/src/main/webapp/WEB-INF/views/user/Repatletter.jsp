						...
						<center>
							<div class="upload_form_cont">
								<form id="upload_form" method="post"
									action="/spsv1/repat/repatletter">
									<div>
										<button class="btn btn-primary" id="upld" type="submit"
											value="repatfile" name="repatfile">Upload File</button>
									</div>
								</form>
							</div>
							<br> <br>
							<form id="upload_form" method="post"
								action="/spsv1/repat/repatfile">
								<div>
									<button class="btn btn-primary" id="upld" type="submit"
										value="repatletter" name="repatletter">Upload file</button>
								</div>
							</form>
							<br> <br>
						...
						<center>
							<form action="/spsv1/Hold/holdfilequery" method="post">
								<button class="button button2" type="submit"
									...
									style="line-height: inherit;">Excute Repat Letter</button>
							</form>
							<br> <br>
							<div>
								<a href="/spsv1/repat/letter"><button value="letterexport"
										id="letterexport" class="btn btn-success">Export
										Repat Letter</button></a> <img id="preview" />
							</div>
