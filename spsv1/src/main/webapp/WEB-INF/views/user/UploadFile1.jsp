...
<jsp:include page="userheader.jsp"></jsp:include>
        ...
        <div class="container">
            ...
            <!-- <div class="contr"><h2> select .xlsx file and click Upload button</h2></div> -->
		<center>
		<h2 class="uploadtitle">Upload Pre-sampling Input File</h2><br><br>
				...
				<%-- 	<form id="upload_form"  method="post" action="/spsv1/cheque/excel">
					...
					<div id="loading">
					 ...
					 <div>
						...
						<!-- <button class="btn btn-primary" id="upld" type="submit" value="Upload Pre-sampling">Upload Pre-sampling</button> -->
