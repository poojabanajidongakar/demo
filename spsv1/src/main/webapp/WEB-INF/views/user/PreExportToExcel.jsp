...
<title>Insert title here</title>
 ...
 <%--  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <link rel="stylesheet" href="/spsv1/css/style.css">
   ...
   <link rel="stylesheet" href="/spsv1/css/jquery-ui.min.css">
   <script src="/spsv1/js/jquery-ui.min.js"></script>
    <spring:url value="/js/dateValidation.js" var="datevalidationjs" />
  <script src="${ datevalidationjs }"></script>
...
<div class="exportExcel">
	...
	<h2>Pre-sampling Export To Excel</h2>
	<!-- <form action="" method="post">
		Start Date : <input type="text" class="datepicker" name="sdate">
		End Date : <input type="text" class="datepicker" name="edate"><br></br>
		<button class="btn btn-primary"><a href="/spsv1/cheque/exportMandateToExcel">Export Mandate</a></button>
		<button class="btn btn-primary exdisc"><a href="">Export Discrepancy</a></button>
	</form> -->

	<form action="/spsv1/Precheque/exportToExcel" method="post">
		Start Date : <input type="text" class="datepicker" name="sdate" autocomplete="off">
		End Date : <input type="text" class="datepicker" name="edate" autocomplete="off"><br></br>
<!-- 		<input class="btn btn-primary expman" type="submit" name="exportExcel" value="Export Mandate"> -->
