...
<div class="mainbody">
	<div id="backcolor" class="menu">
			...
			<ul>
				...
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="">Sampling<span class="caret"></span></a>
				...
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="">One Rs type <span class="caret"></span></a>
					<ul class="dropdown-menu">
				...
				<!-- <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="">One Rs type <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="/spsv1/Precheque/OneRstype?OneRsType=Reverse-Need to check">Reverse-Need to check</a></li> 
						<li><a href="/spsv1/Precheque/OneRstype?OneRsType=Partial Ok">Partial Ok</a></li>
				
					</ul>
				</li>
				 -->
			<!-- 	<li class="dropdown"><a href="/spsv1/cheque/exportExcel">Export To Excel</a></li> -->
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="">Pre-Sampling<span class="caret"></span></a>
					<ul class="dropdown-menu">
