...
<div class="panel-group cheprocess">
	<div class="panel mainheading">
		...
		<form:form action="/spsv1/Precheque/save" method="post" modelAttribute="cheque">
						      	...
						      	<table class="fdetails">
						      	 ...
						      	 <tr>
						      		...
						      		<tr>
						      			...
						      			<td><input type="text" name="rpolicyno" id="vPolicyNo" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete="off" /> </td>
						      		</tr>
						...
						<div class="row readonlydata">
						    <div class="col-sm-6 col-md-6">
						      	<table class="fdetails">
						           	...
						           	<tr>
						      			<td>Name Matched <input type="radio" name="checkName" id="Namechecked" value="Name Matched" class="fakeradio"> </td>
						      		
						      		<td>Ok As Per Document <input type="radio" name="checkName" id="Asperdocs" value="As Per Document" class="fakeradio"> </td>
						      			<!-- <td>
   							 	...
   							 	<tr>
						      			...
						      			<td>
						      				...
						      				<!-- <input type="text" name="reason" id="Reason" tabindex=-1 autocomplete="off" value="" style="width:360px"> -->		
						      			</td>
...
<%-- 				<div class="panel panel-primary">
		 ...
		 --%>
			...
			<div class="chequebtndiv" align="center">
				...
				<input type="submit" name="submit" value="Save and Next" class="save1 checkbtn">	
