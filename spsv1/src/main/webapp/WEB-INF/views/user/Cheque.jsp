...
<div class="panel-group cheprocess">
	<div class="panel mainheading">
		...
		<form:form action="/spsv1/cheque/save" method="post" modelAttribute="cheque">
						    ...
						    <div class="row readonlydata">
						      	<div class="col-sm-6 col-md-6">
						      		<table class="cncd">
						      			<tr>
						      				<td>Customer Name : </td>
						      				<td><input type="text" name="name" readonly  tabindex=-1 value="${cheque.getName()}" onCopy="return false" onPaste="return false" style="width:380px"></td>
						      			</tr>
						      			
						      			<input type="hidden" name="FinalRemarkOners" id="finalremark" value="${cheque.getFinalRemarkOners()}">
						      			
						      			<!-- <tr>
						      			<input type="checkbox" name="checkName" value="Yes"> Name checked<br>
						      			</tr> -->
						      			<tr>
						      			...
						      			<tr>
						      				<td>Policy No : </td>
						      				<td><input type="text"  name="vPolicyNo" id="rpolicyno" onDrag="return false" onDrop="return false" onPaste="return false" readonly tabindex=-1 value="${ cheque.policyno }"></td>
						      			</tr>
						      			<tr>
						      				...
						      				<tr>
						      				<td>Cross Ref. Policy 2 : </td>
						      				<td><input type="text" name="refpolicyno" readonly tabindex=-1 value="${cheque.getCrossrefPolicy2()}" onDrag="return false" onDrop="return false" onPaste="return false"></td>
						      			</tr>
						...
						<div class="row readonlydata">
						    <div class="col-sm-6 col-md-6">
						      	...
						      	<%-- 	  <tr>
						      		 ...
						      		 <tr>
						      			<td>V-Account No. : </td>
						      			<td><input type="text" id="vAccountNumber" name="vAccountNumber" onkeypress="return IsPassword()" value="" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete = "off"></td>
						      		</tr>
						      	    <tr>
						      			<td>M-IFSC code : </td>						   
										<td><input type="text" name="mifscCode" id="mifscCode" value="" onblur="getIfscDetails(this)" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete="off"></td>
						      		 </tr>
						      		 <tr>
						      			<td>Bank Code : </td>
										<td colspan=2><input type="text" name="bankCode" id="bankcode" tabindex=-1 readonly value="${cheque.getBankCode()}"></td>
						      		 </tr>
						      		 <%-- <tr>
						      			<td>Dispatched By : </td>
						      		 ...
						      		 <c:if test = "${cheque.getName() != null}">
						      		  <tr>
						      			<td>Indemnity for Claims : </td>
										<td colspan=2><input type="text" value="Tejas"  name="" id=""></td>
						      		 </tr>
						      		 </c:if>
						      	  </table>
						      </div>			
						      	 ...
						      	 <tr>
										...
										<td>
						      		   ...
						      		   <tr>
						      			<td> DESCR : </td>
										<td>
											<input type="text" name="descr" id="descr" readonly  tabindex=-1 value="${cheque.getDescr()}"  onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false">
										</td>
						      		  </tr> 
						      		<tr>
						      			<td>V Policy No. : </td>
						      			<%-- <td><form:input path="policyno"/> </td> --%>
						      			<td><input type="text" name="rpolicyno" id="vPolicyNo" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" onblur="prn()" autocomplete="off" /> </td>
						      		</tr>
						      	
						      			<tr>
						      				<td>Customer Name : </td>
						      				<td><input type="text" name="name2" readonly  tabindex=-1 value="${cheque.getName()}" onCopy="return false" onPaste="return false" style="width:380px"></td>
						      			</tr>
						      		<tr>
						      				<td>Client Id : </td>
						      		...
						      		<tr>
						      			<td>Bank Name : </td>
						      			<td><input type="text" name="bankName" id="bankName"readonly tabindex=-1  value="" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false"></td>
						      		</tr>
						      		<tr>
						      			<td>M-NM Code : </td>
						      		...
						      		<tr>
						      			<td>Application No. : </td>
						      			<td><input type="text" name="applicationNo" value="" readonly tabindex=-1 onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false"></td>
						      		</tr>
						      	</table>
						     </div>
						 </div>
			...
			<div class="panel panel-primary">
					<div class="panel-heading" align="center">One Rupee Credit</div>
					<div class="panel-body">
						<div class="row readonlydata">
						    <div class="col-sm-6 col-md-6">
						      	<table class="fdetails">
						      			...
						      			<tr>
						      				<td>Customer Name : </td>
						      				<td><input type="text" name="name1" readonly  tabindex=-1 value="${cheque.getName()}" onCopy="return false" onPaste="return false" style="width:380px"></td>
						     		   </tr>
						      
						     		 <tr>
						      			<td>Rupee one Account Number : </td>
										<td><input type="text" id="onersAccountNumber" readonly value="${ cheque.getmAccountNumber()}" name="onersAccountNumber" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete="off"></td>
						      		 </tr>
						      
						           	<tr>
						      			<td>Name matched <input type="radio" name="checkName" id="Namechecked" value="OkToProcess" class="fakeradio"> </td>
						      		
						      			<td>
						      				
						      				<input type="text" name="reason" id="Reason" tabindex=-1 value="" autocomplete="off" style="width:360px">	
						      			</td>
   							 	...
   							 	<tr>
						      			<td>Reverse  <input type="radio" name="checkName" id="reverse" value="reverse" class="fakeradio"></td>
						      
						      			
						      			<td>
						      				
						      				
						      				<input type="text" name="adddiscr" id="newadddiscr" tabindex=-1 autocomplete="off" value="" style="width:360px">		
						      			</td>
						      ...
						      <div class="col-sm-6 col-md-6">
						      	<table class="fdetails">
						      			<tr>
						      				<td>One Rs Name : </td>
						      				<td class="nameradio"><input type="text" name="oneRsName" readonly  tabindex=-1 value="${cheque.getOneRsName()}" onCopy="return false" onPaste="return false" style="width:360px"></td>
						      			</tr>
						      			
						      			
						      	    <tr>
						      			<td>IFSC code : </td>						   
										<td><input type="text" name="onersifscCode" id="onersifscCode" readonly value="${cheque.getIfscCode()}" onCopy="return false" onDrag="return false" onDrop="return false" onPaste="return false" autocomplete="off"></td>
						      		 </tr>
			...
			<div class="chequebtndiv" align="center">
				...
				<input type="submit" name="submit" value="Save and Next" class="save1" id="save1">	
