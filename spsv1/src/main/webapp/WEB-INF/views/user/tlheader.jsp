...
<div class="mainbody">
	<div id="backcolor" class="menu">
		...
		<ul>
			...
			<li><a href="/spsv1/repat/repatletter">Repat Letter</a></li>
		</ul> -->
		<ul>
		<li>
		<a href="/spsv1/Surrenderpi/repatletter">SPI</a>
		</li>
		</ul>
		...
		<!-- <ul>
				<li style="width:5%"><a href="/spsv1/cheque/show">Home</a></li>
				<li class="dropdown" style="width:10%"><a class="dropdown-toggle" data-toggle="dropdown" href="">Sampling<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="/spsv1/cheque/uploadfile">Upload File</a></li>
						<li><a href="/spsv1/cheque/show">To Do List</a></li> 
						<li><a href="/spsv1/cheque/exportExcel">Export To Excel</a></li>
				...
				<li class="dropdown" style="width:10%"><a class="dropdown-toggle" data-toggle="dropdown" href="">One Rs type <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="/spsv1/cheque/OneRstype?OneRsType=Need To Check">Need To Check</a></li> 
						<li><a href="/spsv1/cheque/OneRstype?OneRsType=Partial Ok">Partial Ok</a></li>
					</ul>
				</li>
				<li class="dropdown" style="width:10%"><a class="dropdown-toggle" data-toggle="dropdown" href="">Pre-Sampling<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="/spsv1/Precheque/uploadPrefile">Upload File</a></li>
						<li><a href="/spsv1/Precheque/show">To Do List</a></li>
						<li class="dropdown dropdown-submenu"> ----in a href /spsv1/cheque/showsubtype?paymode=Direct Credit--
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">To Do List </a>
	                        <ul class="dropdown-menu submenu">
	                          <li><a href="/spsv1/Precheque/show?type=maker">Maker</a></li>
	                          <li><a href="/spsv1/Precheque/show?type=checker">Checker</a></li>
	                        </ul>
				...
				<li style="width:5%"><a href="/spsv1/report/MISReport">Report</a></li>
			</ul> -->
	</div>
